...
export function calculateDeliverySum(groups, deliverySelections = {}) {
...
export async function getPrices({ width, height, length, weight }) {
  try {
...
export async function buildCartSummary(items) {
  let itemsSum = 0;

...
export default function DeliveryOptions() {
  ...
  return (
    <div className="flex flex-col gap-3 p-4 bg-bg-secondary rounded-sm w-full lg:w-3/4">
      {isLoading ? (
                ...
                <div className="flex flex-col gap-5 w-full h-[300px] overflow-auto hide-scrollbar">
                  {store.deliveryOptions
                    ...
                    .map((e, idx) => (
                      <div
                        key={idx}
                        className="flex flex-row items-center gap-4 p-4 bg-bg-accent rounded hover:border border-gray-400"
                      >
                        <input
                          type="radio"
